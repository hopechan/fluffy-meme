...
/* harmony import */ var ng2_smart_table__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ng2-smart-table */ "./node_modules/ng2-smart-table/fesm5/ng2-smart-table.js");
...
/* harmony import */ var _services_crud_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../services/crud.service */ "./src/app/services/crud.service.ts");
    ...
    AdminLayoutModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [
                ...
                ng2_completer__WEBPACK_IMPORTED_MODULE_15__["Ng2CompleterModule"],
            ],
            declarations: [
            ...
            providers: [_services_crud_service__WEBPACK_IMPORTED_MODULE_16__["CrudService"]]
        })
    ], AdminLayoutModule);
...
var AdminLayoutRoutes = [
    ...
    { path: 'temp', component: _pages_icons_icons_component__WEBPACK_IMPORTED_MODULE_1__["IconsComponent"] },
    { path: 'humd', component: _pages_maps_maps_component__WEBPACK_IMPORTED_MODULE_2__["MapsComponent"] }
];
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(crud) {
        this.crud = crud;
        this.data = [];
        this.finalData = [];
        this.chartData = {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.crud.getAll().subscribe(function (item) {
            _this.data = item.map(function (i) {
                var tempRow = i.payload.doc.data();
                return {
                    id: i.payload.doc.id,
                    fecha: moment__WEBPACK_IMPORTED_MODULE_3__(tempRow['fecha']).format('MMM Do YYYY'),
                    hora: tempRow['hora'].split(':').map(function (unit) { return unit.padStart(2, '0'); }).join(),
                    temperatura: tempRow['temperatura'].toFixed(2)
                };
            });
            _this.chartData.series[0] = _this.data.map(function (row) { return row.temperatura; });
            new chartist__WEBPACK_IMPORTED_MODULE_4__["Line"]('.ct-chart', _this.chartData);
        });
    };
...
var CrudService = /** @class */ (function () {
    ...
    CrudService.prototype.createData = function (data) {
        return this.firestore.collection('data').add(data);
    };
    CrudService.prototype.getData = function (documentId) {
    ...
    CrudService.prototype.updateData = function (documentId, data) {
        return this.firestore.collection('data').doc(documentId).set(data);
    };
    CrudService.prototype.deleteData = function (documentId) {
